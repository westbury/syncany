 ...
 * that need to be sub-foldered. This feature adds sub folders to some {@link AbstractRemoteFile}
...
public @interface PathAware {
	 ...
	 */
	PathAwareRemoteFileType[] affected() default { PathAwareRemoteFileType.Multichunk, PathAwareRemoteFileType.Temp };
}
