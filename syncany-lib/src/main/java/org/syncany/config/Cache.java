...
public class Cache {
    ...
    public Cache(File cacheDir, Long keepBytes) {
	 ...
	 * property.
	 * 
	 * <p>This method should not be run while an operation is executing.
	 */
	public void clear() {
		clear(keepBytes);
	}
     ...
     */
    public File getFileInCache(String format, Object... params) {
