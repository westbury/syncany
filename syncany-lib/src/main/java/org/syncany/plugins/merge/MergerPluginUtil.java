 ...
 * the required transfer plugin classes -- namely {@link MergerSettings},
 * {@link Merger} and {@link TransferPlugin}.
 *
 * @author Christian Roth <christian.roth@port17.de>
 */
public abstract class MergerPluginUtil {
	...
	private static final String PLUGIN_TRANSFER_SETTINGS_CLASS_NAME = PLUGIN_PACKAGE_NAME + "{1}" + MergerSettings.class.getSimpleName();
	private static final String PLUGIN_TRANSFER_MANAGER_CLASS_NAME = PLUGIN_PACKAGE_NAME + "{1}" + Merger.class.getSimpleName();
	private static final String PLUGIN_TRANSFER_PLUGIN_CLASS_NAME = PLUGIN_PACKAGE_NAME + "{1}" + MergerPlugin.class.getSimpleName();
